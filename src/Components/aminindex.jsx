...
const TopbarAdmin = () => {
  return (
    <header className="sticky top-0 z-40 flex h-18 w-full border-b  bg-white dark:bg-default-50 lg:ps-64 hide-in-print border-[1px] border-solid border-red-500">
